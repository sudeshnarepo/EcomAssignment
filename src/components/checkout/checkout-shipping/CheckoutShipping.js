        ...
        <aside className="checkout__shipping_wrapper">
          ...
          <div className="checkout__shipping_method">
            ...
            <div className="shipping_radio_field">
              ...
              <span>
                {" "}
                <b>Express Delivery</b> (2-5 business days via USPS) $17.95
              </span>
            </div>
            <div className="shipping_radio_field">
              <input
              ...
              <span>
                {" "}
                <b>Next Day Delivery</b> (Next business days via FedEx) $53.61
              </span>
            </div>
          </div>
          ...
          <button
            onClick={handleClick}
            className="checkout__shipping_button"
          >
            {isDesktop ? (
